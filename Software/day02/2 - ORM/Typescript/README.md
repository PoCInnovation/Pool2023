...
⚠️ Even if ORM are perfect for small or simple projects, it will always
...
> 💡 Don't hesitate to go back to previous step if you need it.
...
> ⚠️ If an `Artist` is deleted, his `Contact` must follow. This is what
> we called cascade.
...
You are used to it, write Jest test to verify that everything work well 🚀
...
You already know what to do and how to do, so do it! 🚀
